...
//设备编码类型配置(NET_DVR_COMPRESSION_AUDIO结构)
    ...
    public static final int COMM_ALARMHOST_CID_ALARM= 0x1127;
    /*************操作异常类型(消息方式, 回调方式(保留))****************/
